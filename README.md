...
![Ticket Triage Summary](screenshots/ticket-triage-summary.png)
...
![Suspicious PowerShell Evidence](screenshots/suspicious-powershell-evidence.png)
...
![MITRE ATT&CK Mapping](screenshots/mitre-attack-mapping.png)

### NCSC CAF Mapping

![NCSC CAF Mapping](screenshots/ncsc-caf-mapping.png)

### NIST CSF Mapping

![NIST CSF Mapping](screenshots/nist-csf-mapping.png)

### Detection Query Evidence

![Detection Query Evidence](screenshots/detection-queries.png)
